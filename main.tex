...
\thesistitle{Quantum Machine Learning for Analyzing Galaxies}             % Thesis title,              command: \ttitle
\thesistype{Bachelor Thesis}             % Type of thesis (e.g. Master Thesis) \ttype
\thesisdate{\today}                     % Date of submission                  \tdate
\keywords{quantum machine learning, galaxy analysis, quantum computing}
...
\supervisorA{Prof Dr. Kurt Stockinger}       % Name of supervisor 1,          \supnameA
\supervisorAmail{kurt.stockinger@zhaw.ch}         % Email address of supervisor 1,      \supmailA
...
\supervisorB{Dr. Pavel Sulimov}              % Name of supervisor 2,               \supnameB
\supervisorBmail{pavel.sulimov@zhaw.ch}       % Email address of supervisor 2,      \supmailB
